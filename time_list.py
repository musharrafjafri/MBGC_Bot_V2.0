...
# list1 = time_list_fun()
# time1 = input('Enter start time: ')
# time2 = input('Enter end time: ')
# # time1_index = ''
# # time2_index = ''
# if time1 in list1:
#     time1_index = list1.index(time1) + 1
#
# if time2 in list1:
#     time2_index = list1.index(time2) + 1
#
# print(time1_index, ' : ', time2_index)
# desire_slots = list1[time1_index: time2_index]
# print(desire_slots)
#
